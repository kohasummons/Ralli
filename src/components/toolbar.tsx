...
import { RobotPolaroid } from './robot-head'
...
export const Toolbar: React.FC<ToolbarProps> = ({ onAddPhoto, onAddNote, onRecordVoice, onAddSpotify, onAddDoodle, onAgentStart }) => {
  return (
    <div className="pt-20 mb-4 mx-auto w-full max-w-4xl overflow-hidden">
        <div className="bg-white rounded-2xl h-40 px-4 sm:px-12 relative flex justify-between items-end">
          ...
          <RobotPolaroid onClick={onAgentStart} />
        </div>
    </div>
  )
}
